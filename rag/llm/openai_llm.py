...
class OpenAILLM(BaseLLM, BaseModel):
  ...
  # Endpoint alternativo compatible con la API de OpenAI (Groq, Together,
  # Ollama...). Si es None se usa el de OpenAI.
  ...
  def chat(self, messages: Sequence[ChatMessage], **kwargs) -> ChatResponse:
    ...
    return ChatResponse(
      message=ChatMessage(role=MessageRole.ASSISTANT, content=message),
