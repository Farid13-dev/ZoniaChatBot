...
class TokenTextSplitter(MetadataAwareTextSplitter):
    ...
    def __init__(
        ...
        # 💥 IMPORTANTE: llamar al init de la clase padre Pydantic
        super().__init__(
        ...
        # ✅ Inicializar atributos privados correctamente
        object.__setattr__(self, "_tokenizer", tokenizer or get_tokenizer())
        all_seps = [separator] + (backup_separators or [])
        object.__setattr__(self, "_split_fns", [split_by_sep(sep) for sep in all_seps] + [split_by_char()])
